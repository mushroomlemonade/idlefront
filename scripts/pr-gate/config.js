export const REPO = { owner: "openfrontio", repo: "OpenFrontIO" };
export const TRUSTED_REPO_PERMISSIONS = ["admin", "maintain", "write"];
// Bot authors whose PRs are exempt from the gate (e.g. Dependabot dependency bumps).
export const TRUSTED_BOT_AUTHORS = ["dependabot[bot]"];
...
export const CLOSE_COMMENT = (author) => `Hi @${author}, thanks for the contribution.
